...
export default function New({ history }){
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <label htmlFor="price">VALOR DA DIÁRIA *<span>(em branco para GRAATUITO)</span></label>
            <input id="price" placeholder="Quais tecnologias usam?" value={price} onChange={ event => setPrice(event.target.value) } />
